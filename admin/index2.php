                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Manual Sync" href="#"><span class="main">Manual Sync</span></a></li>
                                <li class="main-clear"><a title="Clear Sync" href="#"><span>Clear Sync</span></a></li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                  <!--   <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                        <i class="icon nalika-alarm" aria-hidden="true"></i><span class="indicator-nt"></span></a> -->
